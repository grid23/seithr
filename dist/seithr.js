...
function (_Event) {
  ...
  function ModelChange(path) {
    ...
    store.get(_assertThisInitialized(_assertThisInitialized(_this))).set(Model_Model, path);
    return _this;
  }
...
function EventDispatcher_createElementDescriptor(def) { var key = EventDispatcher_toPropertyKey(def.key); var descriptor; if (def.kind === "method") { descriptor = { value: def.value, writable: true, configurable: true, enumerable: false }; Object.defineProperty(def.value, "name", { value: EventDispatcher_typeof(key) === "symbol" ? "" : key, configurable: true }); } else if (def.kind === "get") { descriptor = { get: def.value, configurable: true, enumerable: false }; } else if (def.kind === "set") { descriptor = { set: def.value, configurable: true, enumerable: false }; } else if (def.kind === "field") { descriptor = { configurable: true, writable: true, enumerable: true }; } var element = { kind: def.kind === "field" ? "field" : "method", key: key, placement: def.static ? "static" : def.kind === "field" ? "own" : "prototype", descriptor: descriptor }; if (def.decorators) element.decorators = def.decorators; if (def.kind === "field") element.initializer = def.value; return element; }
...
var EventDispatcher_EventDispatcher = EventDispatcher_decorate(null, function (_initialize) {
  ...
  return {
    ...
    d: [{
      ...
      decorators: [decorators_final],
      key: "broadcast",
      value: function value(event, targets) {
...
function UID_createElementDescriptor(def) { var key = UID_toPropertyKey(def.key); var descriptor; if (def.kind === "method") { descriptor = { value: def.value, writable: true, configurable: true, enumerable: false }; Object.defineProperty(def.value, "name", { value: UID_typeof(key) === "symbol" ? "" : key, configurable: true }); } else if (def.kind === "get") { descriptor = { get: def.value, configurable: true, enumerable: false }; } else if (def.kind === "set") { descriptor = { set: def.value, configurable: true, enumerable: false }; } else if (def.kind === "field") { descriptor = { configurable: true, writable: true, enumerable: true }; } var element = { kind: def.kind === "field" ? "field" : "method", key: key, placement: def.static ? "static" : def.kind === "field" ? "own" : "prototype", descriptor: descriptor }; if (def.decorators) element.decorators = def.decorators; if (def.kind === "field") element.initializer = def.value; return element; }
...
function Node_createElementDescriptor(def) { var key = Node_toPropertyKey(def.key); var descriptor; if (def.kind === "method") { descriptor = { value: def.value, writable: true, configurable: true, enumerable: false }; Object.defineProperty(def.value, "name", { value: Node_typeof(key) === "symbol" ? "" : key, configurable: true }); } else if (def.kind === "get") { descriptor = { get: def.value, configurable: true, enumerable: false }; } else if (def.kind === "set") { descriptor = { set: def.value, configurable: true, enumerable: false }; } else if (def.kind === "field") { descriptor = { configurable: true, writable: true, enumerable: true }; } var element = { kind: def.kind === "field" ? "field" : "method", key: key, placement: def.static ? "static" : def.kind === "field" ? "own" : "prototype", descriptor: descriptor }; if (def.decorators) element.decorators = def.decorators; if (def.kind === "field") element.initializer = def.value; return element; }
...
var Node_Node = Node_decorate(null, function (_initialize, _EventTarget) {
  ...
  function (_EventTarget2) {
    ...
    function Node() {
      ...
      _initialize(Node_assertThisInitialized(Node_assertThisInitialized(_this)));

      store.get(Node_assertThisInitialized(Node_assertThisInitialized(_this))).set(snodename, name && name.toString ? name.toString() : "");
      store.get(Node_assertThisInitialized(Node_assertThisInitialized(_this))).set(snodetype, typeof Node[type] == "number" ? Node[type] : Node.OBJECT_NODE);
    ...
    get: function get(target, key) {
      ...
      if (target[key] instanceof Object && !target[key].hook) return revocableProxy(model, target[key], [].concat(Model_toConsumableArray(path), [key]), opts); // if requested property is a function, return the result of that function
          ...
          // push the request to the parent
              ...
              var _arr = [].concat(Model_toConsumableArray(path), [key]);
...
function (_Node) {
  ...
  function Model() {
    ...
    store.get(Model_assertThisInitialized(Model_assertThisInitialized(_this))).set(ssymbol, Symbol.for(_this.uid));
    store.get(Model_assertThisInitialized(Model_assertThisInitialized(_this))).set(soverflow, overflow);
    xref.set(_this.valueOf(), Model_assertThisInitialized(Model_assertThisInitialized(_this)));
    xref.set(store.get(Model_assertThisInitialized(Model_assertThisInitialized(_this))).get(ssymbol), Model_assertThisInitialized(Model_assertThisInitialized(_this)));
    if (ref) xref.set(Symbol.for(ref), Model_assertThisInitialized(Model_assertThisInitialized(_this)));
    store.get(Model_assertThisInitialized(Model_assertThisInitialized(_this))).set(sdata, null);
...
function Cookie_createElementDescriptor(def) { var key = Cookie_toPropertyKey(def.key); var descriptor; if (def.kind === "method") { descriptor = { value: def.value, writable: true, configurable: true, enumerable: false }; Object.defineProperty(def.value, "name", { value: Cookie_typeof(key) === "symbol" ? "" : key, configurable: true }); } else if (def.kind === "get") { descriptor = { get: def.value, configurable: true, enumerable: false }; } else if (def.kind === "set") { descriptor = { set: def.value, configurable: true, enumerable: false }; } else if (def.kind === "field") { descriptor = { configurable: true, writable: true, enumerable: true }; } var element = { kind: def.kind === "field" ? "field" : "method", key: key, placement: def.static ? "static" : def.kind === "field" ? "own" : "prototype", descriptor: descriptor }; if (def.decorators) element.decorators = def.decorators; if (def.kind === "field") element.initializer = def.value; return element; }
...
function (_Event) {
  ...
  function Sync() {
    ...
    store.get(Cookie_assertThisInitialized(Cookie_assertThisInitialized(_this))).set(sfrombrowser, from_browser);
    return _this;
  }
...
var Cookie_Cookie = Cookie_decorate(null, function (_initialize, _Model) {
  ...
  function (_Model2) {
    ...
    function Cookie() {
      ...
      _initialize(Cookie_assertThisInitialized(Cookie_assertThisInitialized(_this2)));

      if (toType(name) != "string") throw new Error(errors_ERR_STRING_EXPECTED);
      store.get(Cookie_assertThisInitialized(Cookie_assertThisInitialized(_this2))).set(sdomain, toType(domain) == "string" ? domain : Cookie.TOP_DOMAIN);
      store.get(Cookie_assertThisInitialized(Cookie_assertThisInitialized(_this2))).set(sexpires, !!session ? "" : !isNaN(+new Date(expires)) ? new Date(expires).toUTCString() : new Date(+new Date() + (+maxAge || LIFESPAN)).toUTCString());
      store.get(Cookie_assertThisInitialized(Cookie_assertThisInitialized(_this2))).set(sname, name);
      store.get(Cookie_assertThisInitialized(Cookie_assertThisInitialized(_this2))).set(Cookie_spath, toType(path) == "string" ? path : "/");
      store.get(Cookie_assertThisInitialized(Cookie_assertThisInitialized(_this2))).set(ssession, !!session);
...
function (_Event) {
  ...
  function CSSRuleEvent(type, _ref) {
    ...
    store.get(CSSRule_assertThisInitialized(CSSRule_assertThisInitialized(_this))).set(scssrule, cssRule);
    return _this;
  }
...
function (_Node) {
  ...
  function CSSRule() {
    ...
    store.get(CSSRule_assertThisInitialized(CSSRule_assertThisInitialized(_this2))).set(sselectortext, args.length > 1 && toType(args[0]) == "string" && isNaN(+args[0]) ? args.shift() : args.length == 1 && toType(args[0]) == "string" ? (fromstr = true, (rcssparse.exec(args[0]) || [])[1] || "") : (fromstr = true, args.shift(), (rcssparse.exec(args[0]) || [])[1] || ""));
...
function (_Node) {
  ...
  function CSSConditionalRule() {
    ...
    store.set(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this)), new WeakMap());
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(stype, type);
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(sconditiontext, conditionText);
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(sbasecsstext, cssText.trim());
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(ssync, false);
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(srules, []);
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(sbufferrules, []);
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(satsheet, []);
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(sadd, function (rule) {
      store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).get(satsheet).push(rule);
      store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(sactive, true);

      _this.insertRule(store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).get(sbufferrules));
    });
    store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(sremove, function (rule) {
      var idx = store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).get(satsheet);
      if (idx !== -1) store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).get(satsheet).splice(idx, 1);
      if (!store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).get(satsheet).length) store.get(CSSConditionalRule_assertThisInitialized(CSSConditionalRule_assertThisInitialized(_this))).set(sactive, false);
    });
    return _this;
  }
...
function (_Event) {
  ...
  function ReadyStateChange(_ref) {
    ...
    store.get(ReadyStateFul_assertThisInitialized(ReadyStateFul_assertThisInitialized(_this))).set(sfrom, from);
    store.get(ReadyStateFul_assertThisInitialized(ReadyStateFul_assertThisInitialized(_this))).set(sto, to);
    return _this;
  }
...
function (_Node) {
  ...
  function View() {
    ...
    store.get(View_assertThisInitialized(View_assertThisInitialized(_this))).set(sprops, {});
    if (props) Object.keys(props).forEach(function (prop) {
      return store.get(View_assertThisInitialized(View_assertThisInitialized(_this))).get(sprops)[prop] = props[prop];
    });
    store.get(View_assertThisInitialized(View_assertThisInitialized(_this))).set(ssubviewAsChild, !!subviewAsChild);
    store.get(View_assertThisInitialized(View_assertThisInitialized(_this))).set(sexpression, ZParser_Parser.parse(expression || _this.template, View_assertThisInitialized(View_assertThisInitialized(_this))));
    store.get(View_assertThisInitialized(View_assertThisInitialized(_this))).set(supdates, store.get(View_assertThisInitialized(View_assertThisInitialized(_this))).get(sexpression).updates.reduce(function (acc, _ref) {
...
function (_Event) {
  ...
  function Ready(sheet) {
    ...
    store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this))).set(ssheet, sheet);
    return _this;
  }
...
function (_Node) {
  ...
  function Stylesheet() {
    ...
    args = null;
    store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).set(Stylesheet_suid, toType(dict.id) == "string" ? dict.id : UID_UID.uid());
    store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).set(swritable, true);
    store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).set(Stylesheet_srules, []);
    store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).set(snode, function (node) {
      ...
      return node;
    }.call(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2)), dict.node || dict.href || void 0));
    store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).set(sready, new Promise(function (resolve, reject) {
      var onload = function onload(e) {
        if (store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).get(swritable) && rules && !!rules.length) _this2.insertRule(rules);
        resolve(store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).get(swritable));
        store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).set(ssheet, store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).get(snode).sheet);

        _this2.dispatchEvent(new Stylesheet_Ready(store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).get("sheet")));
      };

      if ("msSetImmediate" in window) // no events for <style> on ie
        msSetImmediate(onload); //TODO test on edge
      else store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).get(snode).addEventListener("load", onload), store.get(Stylesheet_assertThisInitialized(Stylesheet_assertThisInitialized(_this2))).get(snode).addEventListener("error", function (e) {
          console.error(e);
          reject(e);
        });
    }));
...
function (_EventTarget) {
  ...
  function Vertex(label) {
    ...
    store.set(Vertex_assertThisInitialized(Vertex_assertThisInitialized(_this)), new WeakMap());
    store.get(Vertex_assertThisInitialized(Vertex_assertThisInitialized(_this))).set(sedges, new Set());
    store.get(Vertex_assertThisInitialized(Vertex_assertThisInitialized(_this))).set(sgraphs, new Set());
    _this.label = label;
    return _this;
  }
...
function (_EventTarget) {
  ...
  function Edge(vertices, relation, label) {
    ...
    store.set(Edge_assertThisInitialized(Edge_assertThisInitialized(_this)), new WeakMap());
    store.get(Edge_assertThisInitialized(Edge_assertThisInitialized(_this))).set(svertices, new Set());
...
function (_EventTarget) {
  ...
  function Traversal(graph) {
    ...
    store.set(Traversal_assertThisInitialized(Traversal_assertThisInitialized(_this)), new WeakMap());
    store.get(Traversal_assertThisInitialized(Traversal_assertThisInitialized(_this))).set(Traversal_sgraph, graph);
    return _this;
  }
...
function (_EventTarget) {
  ...
  function Graph() {
    ...
    store.set(Graph_assertThisInitialized(Graph_assertThisInitialized(_this)), new WeakMap());
    store.get(Graph_assertThisInitialized(Graph_assertThisInitialized(_this))).set(sallowed, allows);
    store.get(Graph_assertThisInitialized(Graph_assertThisInitialized(_this))).set(Graph_sedges, new Set());
    store.get(Graph_assertThisInitialized(Graph_assertThisInitialized(_this))).set(Graph_svertices, new Set());
    return _this;
  }
