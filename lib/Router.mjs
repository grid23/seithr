...
import { ERR_RHANDLER, ERR_STRING_EXPECTED } from "./error.mjs"

import Node from "./Node.mjs"
import Route from "./Route.mjs"
import RouteDispatcher from "./RouteDispatcher.mjs"
...
export default class Router extends Node {
    ...
    dispatchRoute(route, ...detail){
        route = route instanceof Route ? route : new Route(route, { detail })
