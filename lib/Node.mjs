...
import { ERR_NODE_NOT_CHILD, ERR_NODE_NOT_IMPLEMENTED, ERR_NOT_A_NODE, ERR_NOT_ITERABLE, ERR_SAME_OBJ } from "./error.mjs"
...
export default class Node extends EventTarget {
    ...
    static leastCommonAncestor(iterable) {
        ...
        // if ( [...nodes].filter(node => node.parentNode).length != nodes.length )
        //   return null
    ...
    constructor({ name="", dummyName="li", type="OBJECT_NODE", value=null } = {}){
        super()
        store.set(this, new WeakMap)
        store.get(this).set(sdummy, document.createElement(dummyName))
