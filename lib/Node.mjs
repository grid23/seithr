...
export default class Node {
    ...
    static get MODEL_DATA_NODE() { return 14 }

    constructor({ name="", type="OBJECT_NODE", value=null, readonly=false } = {}){
        store.set(this, new WeakMap)
        store.get(this).set(sdummy, document.createElement("div"))
    ...
    get childNodes(){
        ...
        return domchildren && children.map(dummy => store.get(dummy))
    }
    ...
    set nodeValue(v){
        ...
        return store.get(this).set(snodevalue, v)
    }
    get parentNode(){
